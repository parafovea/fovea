...
export const ClaimSchema = z.object({
  ...
  confidence: z.number().min(0).max(1).optional(),
  audio: z.array(z.enum(['speech', 'non-speech'])).nullable().optional(),
  video: z.array(z.enum(['text', 'non-text'])).nullable().optional(),
  metadata: z.array(z.enum(['text', 'non-text'])).nullable().optional(),
