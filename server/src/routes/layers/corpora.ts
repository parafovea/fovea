...
const CorpusResponseSchema = Type.Object({
  ...
  annotationDesign: Type.Unknown(),
  expressionCount: Type.Unknown(),
  licensing: Type.Unknown(),
  eprintRefs: Type.Unknown(),
  reproducibility: Type.Unknown(),
  ...
  fastify.post('/corpora', {
    schema: {
      ...
      body: Type.Object({
        ...
        annotationDesign: Type.Optional(Type.Unknown()),
        expressionCount: Type.Optional(Type.Number()),
        licensing: Type.Optional(Type.Unknown()),
        eprintRefs: Type.Optional(Type.Array(Type.String())),
        reproducibility: Type.Optional(Type.Unknown()),
