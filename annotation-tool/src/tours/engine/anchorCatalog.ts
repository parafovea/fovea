...
export const anchorCatalog = {
  ...
  'project-video-assignment': { description: 'The project video-assignment surface.', surface: '/app/projects', conditional: true },
  'groups-page': { description: 'The groups page.', surface: '/app/groups' },
  'group-management-page': { description: 'The group-management page.', surface: '/app/groups' },
