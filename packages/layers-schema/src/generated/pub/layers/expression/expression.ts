...
import type { Anchor, AnnotationMetadata, FeatureMap, KnowledgeRef, LanguageRef } from "./../defs";
...
export interface Expression {
  ...
  */
  anchor?: Anchor;
  /**
  * Timestamp when this expression record was created.
  */
  createdAt: string;
  /**
  ...
  */
  ...
  /**
  * Grounded language references carrying canonical BCP-47 tag, script/region codes, variety label, and a knowledge-graph source (glottolog, iso639-3, cldr). Richer than the languages slug array; use both.
  */
  ...
  */
  mediaRef?: string;
  /**
  * Provenance: who created this expression record, when, with what tool.
  */
