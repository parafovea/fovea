...
- [Audio Transcription API](../api-reference/audio-transcription.md) - External audio API integration
- [External API Configuration](../user-guides/external-apis.md) - User guide for API keys
- [Model Service Configuration](../model-service/configuration.md) - Model selection and settings
- [Audio Processing Architecture](./audio-processing.md) - Audio API provider abstraction
